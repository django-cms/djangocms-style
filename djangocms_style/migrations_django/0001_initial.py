    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_name', models.CharField(blank=True, max_length=50, choices=[('info', 'info'), ('new', 'new'), ('hint', 'hint')], verbose_name='class name', null=True, default='info')),
                ('tag_type', models.CharField(verbose_name='tag Type', default='div', max_length=50, choices=[('div', 'div'), ('article', 'article'), ('section', 'section')])),
