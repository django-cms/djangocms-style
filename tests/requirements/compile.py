...
CONFIG_MATRIX = [
    ...
    ["python3.8", "Django>=3.2a1,<3.3", "django-cms>=4.1,<4.2", "py38-django32-cms41.txt",],
    ...
    ["python3.9", "Django>=3.2a1,<3.3", "django-cms>=4.1,<4.2", "py39-django32-cms41.txt",],
    ...
    ["python3.10", "Django>=4.2a1,<5.0", "django-cms>=4.1,<4.2", "py310-django42-cms41.txt",],

    ["python3.11", "Django>=4.2a1,<5.0", "django-cms>=3.11,<4.0", "py311-django42-cms311.txt",],
    ["python3.11", "Django>=4.2a1,<5.0", "django-cms>=4.1,<4.2", "py311-django42-cms41.txt",],
]
